...
import { SearchServerList } from "../models/operations/search.js";
...
export function search(
  ...
  Result<
    ...
    | errors.SearchUnauthorizedError
    | errors.SearchForbiddenError
    | errors.SearchInternalServerError
    | YouError
...
> {
  ...
  >(
    ...
    M.jsonErr(401, errors.SearchUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.SearchForbiddenError$inboundSchema),
    M.jsonErr(500, errors.SearchInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
